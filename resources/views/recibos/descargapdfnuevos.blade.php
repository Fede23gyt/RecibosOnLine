                ...
                <td width="100%">
                  <div class="page" style="font-size: 8pt">
                    ...
                    <table class="change_order_items" width="100%">
                      ...
                      @foreach ($datos_liq as $item)
                        <?php

                        //** MUESTRA CONCEPTOS DE HABERES **/
                        if($item->hab_rem > 0 or $item->hab_norem > 0 or $item->salario > 0){

                          $tot_hab = $tot_hab + $item->hab_rem + $item->hab_norem + $item->salario;
                          $tot_concepto = $item->hab_rem + $item->hab_norem + $item->salario;
                          $tot_habrem = $tot_habrem + $item->hab_rem.
                          $reng++;
                          ?>
                          <tr style="height:10px">
                            <td style="width: 60%; height:10px" align="left">{{ $item->codigo. ' - ' .$item->descripcion }}
                              <?php //php $haberes[$i] ?>
                            </td>
                        ...
                        {
                          $tot_des = $tot_des + $item->descu;
                          $reng++;
                          ?>
                          <tr style="height:10px">
                            <td style="width: 60%; height:10px" align="left">{{ $item->codigo. ' - ' .$item->descripcion }}</td>
                              <td style="width: 20%; height:10px"></td>
                              <td style="width: 20%; height:10px" align="right"><?php echo number_format($item->descu,2); ?></td>
                          </tr>
                          <?php
                        };
                        ?>
