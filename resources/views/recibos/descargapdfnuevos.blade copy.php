...
$lugar = " Salta, " . [$mes_liq - 1] . " de " . $ano_liq;
...
if ($tip_liq == 'SAC1') {
  $perio = "SAC 1º" . " - " . $anio_liq;
}
if ($tip_liq == 'SAC2') {
  $perio = "SAC 2º" . " - " . $anio_liq;
}
if ($tip_liq == 'ME') {
  $perio = $anio_liq . '-' . $mes_liq;
}
                ...
                <td width="100%">
                  <div class="page" style="font-size: 8pt">
                    ...
                    <table style="width: 100%; font-size: 8pt;">
                      <tr>
                        <td style="width: 50%">Apellido y Nombre: <strong>{{ $datos_leg->apynom }}</strong></td>
                        <td style="width: 50%">CUIL Nº: <strong>{{ $datos_leg->cuil }}</strong></td>
                      </tr>
                    </table>
                    <table style="width: 100%; font-size: 8pt;">
                      <tr>
                        <td style="width: 40%">Cargo: <strong>{{ $datos_leg->categoria }}</strong></td>
                        <td style="width: 40%">Fecha Ingreso: <strong>{{ $datos_leg->fecing }}</strong></td>
                        <!--<td style="width: 20%">Periodo: <strong>{{ $mes_liq }} - {{ $ano_liq }}</strong></td>-->
                        <td style="width: 20%">
                      </tr></td>
                    </table>
                    <table style="width: 100%; font-size: 8pt;">
                    ...
                    <table class="change_order_items" width="100%">
                      ...
                      if($datos_liq->hab_rem > 0 or $datos_liq->hab_norem or $datos_liq->salario){

                        $tot_hab = $tot_hab + $datos_liq->hab_rem + $datos_liq->hab_norem + $datos_liq->salario;
                        $tot_concepto = $datos_liq->hab_rem + $datos_liq->hab_norem + $datos_liq->salario;
                        $tot_habrem = $tot_habrem + $datos_liq->hab_rem.
                        $reng++;
                        ?>
                              <tr style="height:10px">
                                  <td style="width: 60%; height:10px" align="left">{{ $datos_liq->codigo. ' - ' .$datos_liq->descripcion }}
                                    <?php //php $haberes[$i] ?>
                                  </td>
                                  <td style="width: 20%" align="right"><?php echo number_format($tot_concepto,2); ?></td>
                      ...
                      if($datos_liq->descu){
                        ...
                        $tot_des = $tot_des + $datos_liq->descu;
                        $reng++;
                        ?>
                          <tr style="height:10px">
                            <td style="width: 60%; height:10px" align="left">{{ $datos_liq->codigo. ' - ' .$datos_liq->descripcion }}</td>
                              <td style="width: 20%; height:10px"></td>
                              <td style="width: 20%; height:10px" align="right"><?php echo number_format($datos_liq->descu,2); ?></td>
                          </tr>
                        <?php
                      }
                      ?>
                      ...
                      <tr>
                        ...
                        <td style="width: 20%" align="right"><strong>{{ number_format($tot_habrem,2) }}</strong></td>
                        <td></td>
                      </tr>
                    </table>
